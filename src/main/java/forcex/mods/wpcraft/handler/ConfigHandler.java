...
*/      
    ...
    private static void initGeneralConfig(Configuration cfg) {
        cfg.addCustomCategoryComment(MOD_INTEGRATION, "These options will allow you to decide how WallpapersCraft interacts with other mods.");
   ...
   //     enableForestry = cfg.getBoolean("enableForestry", MOD_INTEGRATION, true, "Setting this to false will disable all of the Forestry decorative blocks WallpapersCraft added.");
        hidefromJEI = cfg.getBoolean("hidefromJEI", MOD_INTEGRATION, false, "Setting this to true will hide all WallpapersCraft sub colours and will"
...
/*       
        cfg.addCustomCategoryComment(BLOCKS, "These options will allow you to remove any of the WallpapersCraft blocks from the game");
