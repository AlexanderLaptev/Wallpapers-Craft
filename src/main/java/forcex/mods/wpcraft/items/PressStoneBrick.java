...
public class PressStoneBrick extends Item {
    ...
    public PressStoneBrick() {
        setRegistryName("press_stonebrick");
        setUnlocalizedName("press_stonebrick");
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List tooltipLines, boolean advancedTooltips) {
		tooltipLines.add("Combine this with any solid colored block to apply the Stone Brick pattern.");
	}
